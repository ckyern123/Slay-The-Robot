...
func _ready() -> void:
	...
	var component_tooltip_data: Array[Array] = [
		...
		[food_label, "[color=orange]Food[/color]\nWhen this reaches zero, you lose. \nUpkeep: Each turn, you lose 1 Food, plus 1 more every 30 Prestige", true, false, true, $TooltipPositions/FoodTooltipPos],
		[money_label, "[color=orange]Money[/color]\nMoney is used to purchase cards and fulfil trade orders.", true, false, true, $TooltipPositions/MoneyTooltipPos],
		[ore_label, "[color=orange]Ore[/color]\nOre is used to forge Crafts and build Artifacts.", true, false, true, $TooltipPositions/OreTooltipPos],
		[insight_label, "[color=orange]Insight[/color]\nInsight is used to weave Scrolls and Missives.", true, false, true, $TooltipPositions/InsightTooltipPos],
		[size_label, "[color=orange]Size[/color]\nHow many cards you currently own.", true, false, true, $TooltipPositions/SizeTooltipPos],
		[room_label, "[color=orange]Room[/color]\nRoom is spent to build Artifacts.", true, false, true, $TooltipPositions/RoomTooltipPos],
