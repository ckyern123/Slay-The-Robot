...
func perform_action():
	...
	for action_interceptor_processor in action_interceptor_processors:
		...
		for card_data in picked_cards:
			...
			#var card_value_improvements: Dictionary[String, int] = {"ore_amount": i,"money_amount": i,"food_amount":i}
			var card_value_improvements: Dictionary[String,int] = {}
			for el in card_data.card_values["card_value_improvements"].keys():
				card_value_improvements[el] = i
			if card_data != null:
