...
var sweep_action_data: Array[Dictionary] = [
	{Scripts.ACTION_DRAW_GENERATOR:{"first_pos":true}},
	{
...
var sift_resource_data: Array[Dictionary] = [{
	Scripts.ACTION_PICK_CARDS:
	{
		"min_cards_are_required_for_action": false,
		"random_selection": false,
		...
		"card_pick_type": HandManager.HAND_PILE,
		"card_pick_text": "Choose up to {0} card(s) to discard. {1} cards selected",
		"validator_data":[{Scripts.VALIDATOR_CARD_TYPE:{"card_types_exclude":[CardData.CARD_TYPES.RESOURCE]}}],
		"action_data": [{Scripts.ACTION_DISCARD_CARDS:{}}]}},
	{Scripts.ACTION_DRAW_GENERATOR:{"check_max": true}}]
...
var uses_action_data: Array[Dictionary] = [
...
var inspect_action_old: Dictionary = {
		Scripts.ACTION_PICK_CARDS:
			{
				"min_cards_are_required_for_action": false,
...
var start_action_data: Array[Dictionary] = [
		{
			Scripts.ACTION_VALIDATOR: {
			"validator_data":
			[
...
func add_artifacts() -> void:
	...
	artifact_add_size.artifact_add_actions = [{
		Scripts.ACTION_PICK_CARDS: {
			...
			"action_data": [{Scripts.ACTION_ADD_CARDS_TO_DECK: {}},{Scripts.ACTION_DISCARD_CARDS:{}}],
			"validator_data": [
...
#
	...
	artifact_check_scroll.artifact_description = "Draft a Book every 5 Scroll plays."
	...
	artifact_check_scroll.artifact_texture_path = "external/sprites/status_effects/tied-scroll.png"
...
func add_status_effects() -> void:
	...
	# Reward (simply to explain what objects of interest do)
	var status_effect_sword_reward: StatusEffectData = StatusEffectData.new("status_effect_sword_reward")
	status_effect_sword_reward.status_effect_name = "Sword"
	status_effect_sword_reward.status_effect_texture_path = "external/sprites/status_effects/sword.svg"
	status_effect_sword_reward.status_effect_is_visible = true
	status_effect_sword_reward.status_effect_decay_rate = 0
	status_effect_sword_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_sword_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_sword_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_sword_reward)

	# Reward (simply to explain what objects of interest do)
	var status_effect_appease: StatusEffectData = StatusEffectData.new("status_effect_appease")
	status_effect_appease.status_effect_name = "Appease"
	status_effect_appease.status_effect_texture_path = "external/sprites/status_effects/influence_up.svg"
	status_effect_appease.status_effect_is_visible = true
	status_effect_appease.status_effect_decay_rate = 0
	status_effect_appease.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_appease.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_appease.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_appease)
	
	# Reward (simply to explain what objects of interest do)
	var status_effect_rattle_reward: StatusEffectData = StatusEffectData.new("status_effect_rattle_reward")
	status_effect_rattle_reward.status_effect_name = "Rattle"
	status_effect_rattle_reward.status_effect_texture_path = "external/sprites/status_effects/influence_down.svg"
	status_effect_rattle_reward.status_effect_is_visible = true
	status_effect_rattle_reward.status_effect_decay_rate = 0
	status_effect_rattle_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_rattle_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_rattle_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_rattle_reward)

	# Reward (simply to explain what objects of interest do)
	var status_effect_repair: StatusEffectData = StatusEffectData.new("status_effect_repair")
	status_effect_repair.status_effect_name = "Repair"
	status_effect_repair.status_effect_texture_path = "external/sprites/status_effects/crate_repair.svg"
	status_effect_repair.status_effect_is_visible = true
	status_effect_repair.status_effect_decay_rate = 0
	status_effect_repair.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_repair.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_repair.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_repair)
	...
	status_effect_delicacy_reward.status_effect_texture_path = "external/sprites/status_effects/delicacy_status.svg"
	...
	status_effect_refresh_reward.status_effect_texture_path = "external/sprites/status_effects/refresh_status.svg"
	...
	status_effect_rattle.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_rattle.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_rattle.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_rattle)
	
		# Reward (simply to explain what objects of interest do)
	var status_effect_elite: StatusEffectData = StatusEffectData.new("status_effect_elite")
	status_effect_elite.status_effect_name = "ELITE (You must explore this before venturing forth)"
	status_effect_elite.status_effect_texture_path = "external/sprites/status_effects/elite.svg"
	status_effect_elite.status_effect_is_visible = true
	status_effect_elite.status_effect_decay_rate = 0
	status_effect_elite.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_elite.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_elite.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_elite)
	...
	status_effect_debt_once.status_effect_texture_path = "external/sprites/status_effects/debt.svg"
	...
	status_effect_insight_reward.status_effect_texture_path = "external/sprites/status_effects/insight_status.svg"
	...
	Global.register_rod(status_effect_insight_reward)
			...
			# Reward (simply to explain what objects of interest do)
	var status_effect_scroll_reward: StatusEffectData = StatusEffectData.new("status_effect_scroll_reward")
	status_effect_scroll_reward.status_effect_name = "Insight"
	status_effect_scroll_reward.status_effect_texture_path = "external/sprites/status_effects/scroll.svg"
	status_effect_scroll_reward.status_effect_is_visible = true
	status_effect_scroll_reward.status_effect_decay_rate = 0
	status_effect_scroll_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_scroll_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_scroll_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_scroll_reward)
	# Reward (simply to explain what objects of interest do)
	...
	status_effect_draft_reward.status_effect_texture_path = "external/sprites/status_effects/draft.svg"
	status_effect_draft_reward.status_effect_is_visible = true
	status_effect_draft_reward.status_effect_decay_rate = 0
	status_effect_draft_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_draft_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_draft_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_draft_reward)
	
	var status_effect_draft_trade_reward: StatusEffectData = StatusEffectData.new("status_effect_draft_trade_reward")
	status_effect_draft_trade_reward.status_effect_name = "Trade Order Draft"
	status_effect_draft_trade_reward.status_effect_texture_path = "external/sprites/status_effects/draft_trade.svg"
	status_effect_draft_trade_reward.status_effect_is_visible = true
	status_effect_draft_trade_reward.status_effect_decay_rate = 0
	status_effect_draft_trade_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_draft_trade_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_draft_trade_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_draft_trade_reward)
	
	var status_effect_draft_improved_reward: StatusEffectData = StatusEffectData.new("status_effect_draft_improved_reward")
	status_effect_draft_improved_reward.status_effect_name = "Uncommon/Rare Faction Draft"
	status_effect_draft_improved_reward.status_effect_texture_path = "external/sprites/status_effects/draft_improved.svg"
	status_effect_draft_improved_reward.status_effect_is_visible = true
	status_effect_draft_improved_reward.status_effect_decay_rate = 0
	status_effect_draft_improved_reward.status_effect_decay_type = StatusEffectData.STATUS_EFFECT_DECAY_TYPES.LINEAR
	status_effect_draft_improved_reward.status_effect_type = StatusEffectData.STATUS_EFFECT_TYPES.BUFF
	status_effect_draft_improved_reward.status_effect_action_process_times = []
	
	Global.register_rod(status_effect_draft_improved_reward)
	...
	status_effect_fertiliser_reward.status_effect_texture_path = "external/sprites/status_effects/fertiliser_status.svg"
	...
	status_effect_money_reward.status_effect_texture_path = "external/sprites/status_effects/money_status.svg"
...
func add_colors() -> void:
	...
	color_blue.color_energy_icon_texture_path = "external/sprites/colors/blueenergy.svg"
	...
	color_white.color_energy_icon_texture_path = "external/sprites/colors/whiteenergy.svg"
	...
	color_grey.color_energy_icon_texture_path = "external/sprites/colors/whiteenergy.svg"
...
func add_keywords() -> void:
	...
	keyword_forge.keyword_text_bb_code = "Spend 1{0} to create a Craft.".format([Card.ORE_ICON_KEYWORD])
	...
	keyword_sweep.keyword_name = "Sweep X"
	keyword_sweep.keyword_text_bb_code = "Discard X rightmost cards, then draw leftmost cards."
	Global.register_rod(keyword_sweep)
	
	var keyword_sift: KeywordData = KeywordData.new("keyword_sift")
	keyword_sift.keyword_name = "Sift X for Y"
	...
	keyword_sword.keyword_status_effect_id = "status_effect_sword_reward"
	keyword_sword.keyword_text_bb_code = "Craft that Explores 2{0}. Can be Wielded. Has 3 uses.".format([Card.EXPLORE_ICON_KEYWORD])
	Global.register_rod(keyword_sword)
	
	var keyword_debt: KeywordData = KeywordData.new("keyword_debt")
	keyword_debt.keyword_name = "Debt"
	keyword_debt.keyword_status_effect_id = "status_effect_debt_once"
	keyword_debt.keyword_text_bb_code = "Craft that loses 1{0} at the end of turn. Has 2 uses.".format([Card.MONEY_ICON_KEYWORD])
	...
	keyword_spice.keyword_status_effect_id = "status_effect_spice_reward"
	keyword_spice.keyword_text_bb_code = "Craft that appeases all cards in hand. Has 2 uses."
	...
	keyword_scroll.keyword_status_effect_id = "status_effect_scroll_reward"
	keyword_scroll.keyword_text_bb_code = "Craft that is used to draft Books. Has 2 uses."
	...
	keyword_missives.keyword_status_effect_id = "status_effect_missives_reward"
	keyword_missives.keyword_text_bb_code = "Craft that discards 2 rightmost cards and draws 4. Has Retain and 2 uses."
	...
	keyword_appease.keyword_status_effect_id = "status_effect_appease"
	keyword_appease.keyword_text_bb_code = "Increases a Faction card's influence."
	...
	keyword_repair.keyword_status_effect_id = "status_effect_repair"
	keyword_repair.keyword_text_bb_code = "Increases a Craft card's uses (Does not affect cards with exhaust)."
	...
	keyword_rattle.keyword_status_effect_id = "status_effect_rattle"
	keyword_rattle.keyword_text_bb_code = "Decreases a Faction card's influence."
...
func add_characters() -> void:
	...
	character_green.character_description = "To start, just start the run. \nKEY SHORTCUTS: Number keys (0-9) can be used to play cards at a position in hand; Press E to End Turn; Press V to Venture Forth; Right click to preview card upgrade.\n\nIMPORTANT NOTE: Faction cards have an additional property called Influence (represented by Purple Heart). Everytime they are played, the card's influence goes up by 1. If it reaches 7, the next time the card is played, it is upgraded (To preview card upgrade, right click it). \n\nEvery time a Faction card remains in hand at the end of turn, the card's influence goes down by 1. If it goes to 0, it becomes a Rebel, a useless and detrimental card."
...
#
	...
	### Upsides
	# add money
	var run_start_option_add_insight: RunStartOptionData = RunStartOptionData.new("run_start_option_add_insight")
	run_start_option_add_insight.run_start_option_bb_code = "[color=green]Gain 1 insight[/color]"
	run_start_option_add_insight.run_start_option_type = RunStartOptionData.RUN_START_OPTION_TYPES.PARTIAL_UPSIDE
	run_start_option_add_insight.run_start_option_actions = [{Scripts.ACTION_ADD_INSIGHT: {"insight_amount": 1}}]

	Global.register_rod(run_start_option_add_insight)
...
#region enemies forest
	...
	forestfloor.enemy_initial_status_effects = {"status_effect_treasure_reward": 1, "status_effect_room_reward": 1,"status_effect_insight_reward":1}
	# initial dummy state used to map initial attack pattern weights on starting combat
	forestfloor.add_intent_state([
		EnemyIntentData.new(EnemyIntentData.INTENT_INITIAL, DIFFICULTY_STARTING, 0, 0, "", 0, "", {"intent_block":1}),
		])
	forestfloor.enemy_actions_on_death = [{Scripts.ACTION_CREATE_CARDS:{"created_card_object_id":"card_treasure","number_of_cards":1,"action_data":[{Scripts.ACTION_DISCARD_CARDS:{}}]}},{Scripts.ACTION_ADD_ROOM:{"room_amount": 1}},{Scripts.ACTION_ADD_INSIGHT:{"insight_amount":1}}]
	# an attack that hits harder on higher difficulties
	forestfloor.add_intent_state([
		EnemyIntentData.new("intent_block", DIFFICULTY_STARTING, 0, 0, "", 0, ""),
		EnemyIntentData.new("intent_block", DIFFICULTY_STANDARD_ENEMIES_HARDER, 0, 0, "", 0, "", {"intent_block":1}),
	...
	abandonedoutpost.enemy_initial_status_effects = {"status_effect_draft_trade_reward":1, "status_effect_missives_reward": 1}
	# initial dummy state used to map initial attack pattern weights on starting combat
	abandonedoutpost.add_intent_state([
		EnemyIntentData.new(EnemyIntentData.INTENT_INITIAL, DIFFICULTY_STARTING, 0, 0, "", 0, "", {"intent_block":1}),
		])
	abandonedoutpost.enemy_actions_on_death = [		{Scripts.ACTION_PICK_CARDS:
		{
			"card_pick_type": ActionBasePickCards.PICK_DRAFT,
			"pick_draft_cards": false,
			"draft_from_card_pool": true,
		...
		}},{Scripts.ACTION_CREATE_CARDS:{"created_card_object_id":"card_missives","number_of_cards":1,"action_data":[{Scripts.ACTION_DISCARD_CARDS:{}}]}}]
	# an attack that hits harder on higher difficulties
	abandonedoutpost.add_intent_state([
		EnemyIntentData.new("intent_block", DIFFICULTY_STARTING, 0, 0, "", 0, ""),
		EnemyIntentData.new("intent_block", DIFFICULTY_STANDARD_ENEMIES_HARDER, 0, 0, "", 0, "", {"intent_block":1}),
	...
	banditroost.enemy_initial_status_effects = {"status_effect_draft_trade_reward":1, "status_effect_money_reward": 5, "status_effect_debt_once":1}
	# initial dummy state used to map initial attack pattern weights on starting combat
	banditroost.add_intent_state([
		EnemyIntentData.new(EnemyIntentData.INTENT_INITIAL, DIFFICULTY_STARTING, 0, 0, "", 0, "", {"intent_debt":1}),
		])
	banditroost.enemy_actions_on_death = [{Scripts.ACTION_PICK_CARDS:
		{
			"card_pick_type": ActionBasePickCards.PICK_DRAFT,
			"pick_draft_cards": false,
			"draft_from_card_pool": true,
			...
			"rng_name": "rng_card_drafting",
			"draft_card_pack_id": "card_pack_grey"
		}},{Scripts.ACTION_ADD_MONEY:{"money_amount":5}}]
	# an attack that hits harder on higher difficulties
...
func add_card_decorators() -> void:
	...
	card_decorator_frontier_money.card_decorator_post_description = "[center][color=green]FRONTIER: Gain 2{0}[/color][/center]\n".format([Card.MONEY_ICON_KEYWORD])
	card_decorator_frontier_money.card_decorator_label_value_name = "decorator_value_frontier_money"
	card_decorator_frontier_money.card_decorator_post_play_actions = [
		{
	...
	# decorator that draws extra cards when the card is drawn the first time
	# applies a custom decorator value to the card and displays the number on the decorator
	var card_decorator_discard_food: CardDecoratorData = CardDecoratorData.new("card_decorator_discard_food")
	card_decorator_discard_food.card_decorator_texture_path = "external/sprites/card_decorators/green_decorator.png"
	card_decorator_discard_food.card_decorator_post_description = "[center][color=green]ON DISCARD: Gain 2{0}[/color][/center]\n".format([Card.FOOD_ICON_KEYWORD])
	card_decorator_discard_food.card_decorator_label_value_name = "decorator_value_discard_food"
	card_decorator_discard_food.card_decorator_post_discard_actions = [
		{Scripts.ACTION_ADD_FOOD: {"food_amount":2}},
		]
	Global.register_rod(card_decorator_discard_food)
	...
	card_decorator_extra_draw.card_decorator_post_description = "[center][color=green]Draw 2.[/color][/center]\n"
	card_decorator_extra_draw.card_decorator_label_value_name = "decorator_value_extra_draw"
	card_decorator_extra_draw.card_decorator_post_play_actions = [
...
func add_card_basics() -> void:
	...
	for i: int in len(colors):
		...
		card_basic_ore.card_name = "Ore Collector"
		...
		card_basic_money.card_name = "Tax Collector"
		...
		card_basic_weave.card_name = "Novice Weaver"
		card_basic_weave.card_color_id = "color_{0}".format([colors[i]])
		card_basic_weave.card_description = "Weave [insight_required] Scroll."
...
func add_cards_misc() -> void:
	...
	#card_fish.card_discard_actions = [{Scripts.ACTION_CREATE_CARDS:{"created_card_object_id":"card_fish","number_of_cards":1,"action_data":[{Scripts.ACTION_DISCARD_CARDS:{"is_manual_discard":false}}]}}]
	...
	card_scroll.card_texture_path = "external/sprites/status_effects/scroll.svg"
	card_scroll.card_description = "For every 5th time a Scroll is played, draft a Book."
	...
	var card_steelflame: CardData = CardData.new("card_steelflame")
	card_steelflame.card_name = "Steel Flame"
	card_steelflame.card_color_id = "color_{0}".format([color])
	card_steelflame.card_texture_path = "external/sprites/status_effects/sword.svg"
	card_steelflame.card_description = "Explore [damage]{0} twice. Draw a card.".format([Card.EXPLORE_ICON_KEYWORD])
	card_steelflame.card_type = CardData.CARD_TYPES.CRAFT
	card_steelflame.card_subtype = CardData.CARD_SUBTYPES.FORGED
	card_steelflame.card_keyword_object_ids = ["keyword_wield"]
	...
	var card_bandit: CardData = CardData.new("card_bandit")
	card_bandit.card_name = "Bandit"
	card_bandit.card_color_id = "color_{0}".format([color])
	card_bandit.card_texture_path = "external/sprites/cards/basic/02_sail.png"
	card_bandit.card_description = "Unplayable.\nFRONTIER: Play to exhaust the card.\nLose 1{0} at the end of turn.".format([Card.FOOD_ICON_KEYWORD])
	card_bandit.card_keyword_object_ids = ["keyword_frontier"]
	card_bandit.card_type = CardData.CARD_TYPES.CURSE
	card_bandit.card_energy_cost = 0
	card_bandit.card_rarity = CardData.CARD_RARITIES.GENERATED
	card_bandit.card_influence = 0
	card_bandit.card_requires_target = false
	...
	var card_hubris: CardData = CardData.new("card_hubris")
	...
	card_blueprint.card_description = "Spend 8{0} and 1{1} to gain [artifact_name]\n([artifact_description])".format([Card.ORE_ICON_KEYWORD, Card.ROOM_ICON_KEYWORD])
	...
	card_blueprint.card_values = {"ore_amount": -8,"artifact_name":"","artifact_description":"","artifact_id":""}
...
#region Trade
	...
	card_food_manual.card_values = {"food_amount": 1}
	...
	waste_not_manual.card_description = "Adds 'ON DISCARD: Gain 2{0}' to a card in hand.".format([Card.FOOD_ICON_KEYWORD])
	waste_not_manual.card_keyword_object_ids = ["keyword_retain"]
	waste_not_manual.card_type = CardData.CARD_TYPES.CRAFT
	waste_not_manual.card_subtype = CardData.CARD_SUBTYPES.WOVEN
	waste_not_manual.card_energy_cost = 0
	waste_not_manual.card_is_retained = true
	waste_not_manual.card_influence = 0
	waste_not_manual.card_rarity = CardData.CARD_RARITIES.GENERATED
	waste_not_manual.card_requires_target = false
	#waste_not_manual.card_values = {"status_charge_amount": 1}
	waste_not_manual.card_play_actions = [{
		Scripts.ACTION_PICK_CARDS:
				{
				"min_card_amount": 1,
				"max_card_amount": 1,
				...
				"card_pick_text": "Choose {0} card to add. {1} cards selected",
				"action_data": [		{
				Scripts.ACTION_DECORATE_CARDS:{"decorate_parent_card": false,"card_decorator_object_id":"card_decorator_discard_food"}
		}]
		}
		}]
	Global.register_rod(waste_not_manual)
	...
	card_inspectors_almanac.card_name = "Inspector's Almanac"
	card_inspectors_almanac.card_color_id = "color_blue"
	card_inspectors_almanac.card_texture_path = "external/sprites/status_effects/book.svg"
	card_inspectors_almanac.card_description = "Inspect [max_card_amount]."
	card_inspectors_almanac.card_type = CardData.CARD_TYPES.CRAFT
	card_inspectors_almanac.card_subtype = CardData.CARD_SUBTYPES.WOVEN
	card_inspectors_almanac.card_is_retained = true
	card_inspectors_almanac.card_influence = 0
	card_inspectors_almanac.card_energy_cost = 0
...
func add_cards_purple() -> void:
	...
	card_cunningtrader.card_values = {"ore_amount": 2,"created_card_object_id": "card_debt", "number_of_cards": 1,"money_amount": 1}
	...
	card_pearlemissary.card_description = "Discard [discard_count] rightmost cards, then draw [draw_count].\nON DISCARD: Randomly Appease 2 cards in discard pile."
	...
	card_saltexpert.card_values = {"min_card_amount":3, "max_card_amount": 3,"card_value_improvements":{"food_amount":1}}
	card_saltexpert.card_upgrade_value_improvements = {"min_card_amount": 2, "max_card_amount": 2}
	...
	card_minnowtrader.card_description = "Tick down Shop Refresh by [refresh_amount]. Draft a Trade Order."
	card_minnowtrader.card_type = CardData.CARD_TYPES.FACTION
	card_minnowtrader.card_subtype = CardData.CARD_SUBTYPES.PEARL
	card_minnowtrader.card_rarity = CardData.CARD_RARITIES.UNCOMMON
	...
	card_minnowtrader.card_play_actions = [{Scripts.ACTION_PICK_CARDS:
		{
			"card_pick_type": ActionBasePickCards.PICK_DRAFT,
			"pick_draft_cards": false,
			"draft_from_card_pool": true,
	...
	card_pearldancer.card_description = "Gain [energy_amount]{0}. Create [number_of_cards] Debt.".format([Card.ENERGY_ICON_KEYWORD])
	card_pearldancer.card_type = CardData.CARD_TYPES.FACTION
	card_pearldancer.card_subtype = CardData.CARD_SUBTYPES.PEARL
	card_pearldancer.card_rarity = CardData.CARD_RARITIES.COMMON
	card_pearldancer.card_requires_target = false
	card_pearldancer.card_energy_cost = 2
	card_pearldancer.card_values = {"energy_amount":4,"number_of_cards":1,"created_card_object_id":"card_debt"}
	...
	card_pearlregaler.card_type = CardData.CARD_TYPES.FACTION
	...
	card_dregpilferer.card_requires_target = true
	card_dregpilferer.card_energy_cost = 1
	card_dregpilferer.card_glow_validators = [{Scripts.VALIDATOR_CARD_POSITION_IN_HAND:{"position_in_hand":"right"}}]
	card_dregpilferer.card_values = {"damage": 4, "number_of_attacks": 1, "created_card_object_id":"card_treasure","number_of_cards":1}
	card_dregpilferer.card_upgrade_value_improvements = {"number_of_cards": 1}
	card_dregpilferer.card_influence = 3
	card_dregpilferer.card_play_actions = [
		{
			Scripts.ACTION_VALIDATOR:{
				"validator_data":[{Scripts.VALIDATOR_CARD_POSITION_IN_HAND:{"position_in_hand":"right"}}],
				"passed_action_data":[{Scripts.ACTION_CREATE_CARDS:{"created_card_object_id":"card_treasure", "custom_key_names":{"number_of_cards":"number_of_cards"}, "action_data":[{Scripts.ACTION_DISCARD_CARDS:{}}]}}]
			}
		}
		,{
		Scripts.ACTION_ATTACK_GENERATOR:{}
	...
	card_flintlockaccountant.card_keyword_object_ids = ["keyword_repair"]
	card_flintlockaccountant.card_description = "Return up to [max_card_amount] Crafts from your discard pile to your hand. Repair 3 to returned cards."
	...
	card_pearlscribe.card_texture_path = "external/sprites/cards/pearl/09_pearlscribe.png"
	...
	card_courthand.card_keyword_object_ids = ["keyword_spice","keyword_appease"]
...
func add_cards_black() -> void:
	...
	card_fishwrangler.card_description = "Create [number_of_cards] Fish, then Sift [draw_count] for Craft cards."
	...
	card_aniseedenvoy.card_type = CardData.CARD_TYPES.FACTION
	card_aniseedenvoy.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	card_aniseedenvoy.card_rarity = CardData.CARD_RARITIES.COMMON
	card_aniseedenvoy.card_influence = 3
	card_aniseedenvoy.card_requires_target = false
	...
	card_flintlockswiftshot.card_description = "Explore [damage]{0}.If you've completely explored this way, gain [energy_amount]{1}.\n\nON DISCARD: Improve Explore{0} by 1.".format([Card.EXPLORE_ICON_KEYWORD,Card.ENERGY_ICON_KEYWORD])
	...
	card_aniseedscribe.card_description = "Draw [draw_count]. If draw pile has 20 or more cards, gain [insight_amount]{0}.".format([Card.INSIGHT_ICON_KEYWORD])
	card_aniseedscribe.card_type = CardData.CARD_TYPES.FACTION
	card_aniseedscribe.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	...
	card_aniseedscribe.card_play_actions = [
		{
		Scripts.ACTION_VALIDATOR:{
			"validator_data":[{Scripts.VALIDATOR_PILE_SIZE:{"card_pick_type": HandManager.DRAW_PILE,
				"operator":">=","comparison_value":20}}],
			"passed_action_data": [{Scripts.ACTION_ADD_INSIGHT: {"insight_amount":1}}]
			}
		},
				{
		Scripts.ACTION_DRAW_GENERATOR: {}
	...
	card_peddlerveteran.card_description = "Gain [money_amount]{0}. Tick down Refresh Shop by [refresh_amount].".format([Card.MONEY_ICON_KEYWORD])
	card_peddlerveteran.card_type = CardData.CARD_TYPES.FACTION
	card_peddlerveteran.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	...
	card_peddlerveteran.card_values = {"money_amount": 3,"refresh_amount":2}
	...
	card_spicyepicure.card_type = CardData.CARD_TYPES.FACTION
	card_spicyepicure.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	card_spicyepicure.card_rarity = CardData.CARD_RARITIES.UNCOMMON
	card_spicyepicure.card_requires_target = false
	card_spicyepicure.card_energy_cost = 3
	card_spicyepicure.card_influence = 5
	card_spicyepicure.card_values = {"min_card_amount":1,"max_card_amount":1,"energy_amount":1,"draw_count":1}
	card_spicyepicure.card_upgrade_value_improvements = {"min_card_amount":1,"max_card_amount":1}
	card_spicyepicure.card_play_actions = [
				{
			Scripts.ACTION_PICK_CARDS: {
				"min_card_amount":99,
				"max_card_amount":99,
				...
				"validator_data": [{Scripts.VALIDATOR_CARD_ID:{"card_object_ids":["card_spice"]}}],
				"action_data": [
				{Scripts.ACTION_VARIABLE_CARDSET_MODIFIER: {
				"multiplied_values": ["energy_amount","draw_count"],
				"action_data": [{Scripts.ACTION_DRAW_GENERATOR:{}},{Scripts.ACTION_ADD_ENERGY:{}}]
				}}]
			}
		}]
	...
	card_keeneyedbuccaneer.card_description = "Shuffle your discard pile into your draw pile. Explore 1{0} for each Sword in your draw pile.\nON DISCARD: Gain [energy_amount]{1}.".format([Card.EXPLORE_ICON_KEYWORD,Card.ENERGY_ICON_KEYWORD])
	card_keeneyedbuccaneer.card_type = CardData.CARD_TYPES.FACTION
	card_keeneyedbuccaneer.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	...
	card_keeneyedbuccaneer.card_values = {"damage": 1,"number_of_attacks":1,"energy_amount":1}
	...
	card_aniseedtaxcollector.card_description = "Discard [discard_count] rightmost cards, then draw [draw_count], then Inspect [max_card_amount]."
	...
	card_peddlerinformant.card_description = "Create [number_of_cards] Scroll(s), Create 1 Debt. Reshuffle."
	card_peddlerinformant.card_keyword_object_ids = ["keyword_scroll","keyword_debt"]
	card_peddlerinformant.card_type = CardData.CARD_TYPES.FACTION
	card_peddlerinformant.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	...
	card_peddlerinformant.card_play_actions = [
		...
		{
			Scripts.ACTION_CREATE_CARDS:{
				"created_card_object_id":"card_debt",
				"number_of_cards":1,
				"action_data":[{Scripts.ACTION_DISCARD_CARDS:{}}]
			}
		}
	...
	card_taxfarmer.card_description = "Gain [money_amount]{0} for every [card_dividend] cards in draw pile.".format([Card.MONEY_ICON_KEYWORD])
	card_taxfarmer.card_type = CardData.CARD_TYPES.FACTION
	card_taxfarmer.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	card_taxfarmer.card_rarity = CardData.CARD_RARITIES.RARE
	card_taxfarmer.card_requires_target = false
	card_taxfarmer.card_energy_cost = 2
	card_taxfarmer.card_influence = 4
	card_taxfarmer.card_values = {"money_amount":1, "card_dividend":3}
	...
	card_eruditeforger.card_subtype = CardData.CARD_SUBTYPES.ANISEED
	card_eruditeforger.card_rarity = CardData.CARD_RARITIES.RARE
	card_eruditeforger.card_requires_target = false
	card_eruditeforger.card_energy_cost = 3
	...
	card_swashbucklingchamp.card_description = "Explore [damage]{0}, then Wield [min_card_amount]. Repair 2 and improve Explore {0} by 1 to Wielded cards.".format([Card.EXPLORE_ICON_KEYWORD])
	card_swashbucklingchamp.card_keyword_object_ids = ["keyword_wield","keyword_sword"]
...
func add_cards_green() -> void:
	...
	card_cofferskeeper.card_type = CardData.CARD_TYPES.FACTION
	card_cofferskeeper.card_subtype = CardData.CARD_SUBTYPES.JADE
	...
	card_youngmentor.card_values = {"card_influence":2}
	card_youngmentor.card_upgrade_value_improvements = {"card_influence":2}
	...
	card_luckfinder.card_energy_cost = 2
	...
	card_commercialcropper.card_texture_path = "external/sprites/cards/jade/17_commercialcropper.png"
	...
	card_commercialcropper.card_type = CardData.CARD_TYPES.FACTION
	card_commercialcropper.card_subtype = CardData.CARD_SUBTYPES.JADE
	card_commercialcropper.card_rarity = CardData.CARD_RARITIES.COMMON
	card_commercialcropper.card_requires_target = false
	card_commercialcropper.card_energy_cost = 0
	card_commercialcropper.card_influence = 2
	card_commercialcropper.card_values = {"artifact_charge_increase":2,"refresh_amount":1}
	...
	card_avidsower.card_description = "Reshuffle your discard pile into your draw pile. Fertilise [artifact_charge_increase].".format([Card.EXPLORE_ICON_KEYWORD])
	card_avidsower.card_keyword_object_ids = ["keyword_fertilise"]
	card_avidsower.card_type = CardData.CARD_TYPES.FACTION
	card_avidsower.card_subtype = CardData.CARD_SUBTYPES.JADE
	card_avidsower.card_rarity = CardData.CARD_RARITIES.COMMON
	card_avidsower.card_requires_target = false
	card_avidsower.card_influence = 4
	card_avidsower.card_energy_cost = 2
	card_avidsower.card_values = {"artifact_charge_increase":3}
	card_avidsower.card_upgrade_value_improvements = {"artifact_charge_increase":2}
	...
	card_intrepidjourneyman.card_name = "Intrepid Journeyman"
	card_intrepidjourneyman.card_color_id = "color_{0}".format([color])
	card_intrepidjourneyman.card_texture_path = "external/sprites/cards/jade/20_intrepidjourneyman.png"
	card_intrepidjourneyman.texture_bg_path = "external/sprites/cards/frames/jadeframe.png"
	card_intrepidjourneyman.card_description = "Explore [damage]{0}.\nIf your discard pile has 15 or more cards, gain [energy_amount]{1}.".format([Card.EXPLORE_ICON_KEYWORD,Card.ENERGY_ICON_KEYWORD])
	card_intrepidjourneyman.card_type = CardData.CARD_TYPES.FACTION
	card_intrepidjourneyman.card_subtype = CardData.CARD_SUBTYPES.JADE
	card_intrepidjourneyman.card_rarity = CardData.CARD_RARITIES.COMMON
	card_intrepidjourneyman.card_requires_target = true
	card_intrepidjourneyman.card_energy_cost = 3
	card_intrepidjourneyman.card_influence = 5
	card_intrepidjourneyman.card_values = {"damage":10,"number_of_attacks":1,"energy_amount":1}
	card_intrepidjourneyman.card_upgrade_value_improvements = {"damage":5}
	card_intrepidjourneyman.card_play_actions = [{Scripts.ACTION_VALIDATOR:{
		"validator_data":[{Scripts.VALIDATOR_PILE_SIZE:{ "card_pick_type":HandManager.DISCARD_PILE,"comparison_value":15}}],
	...
	card_everymanleader.card_values = {"max_card_amount":2,"draw_count":4,"discard_count":2}
	...
	card_inspiredgossipmonger.card_type = CardData.CARD_TYPES.FACTION
	card_inspiredgossipmonger.card_subtype = CardData.CARD_SUBTYPES.JADE
	...
	card_wizenedforager.card_influence = 4
	...
	card_pantryraider.card_rarity = CardData.CARD_RARITIES.UNCOMMON
	card_pantryraider.card_requires_target = true
	card_pantryraider.card_energy_cost = 2
	card_pantryraider.card_influence = 4
	card_pantryraider.card_values = {"damage":1 ,"number_of_attacks":1,"min_card_amount":1,"max_card_amount":1}
	card_pantryraider.card_upgrade_value_improvements = {"min_card_amount":1,"max_card_amount":1}
	card_pantryraider.card_play_actions = [
	{
		Scripts.ACTION_PICK_CARDS:
		{
			"min_card_amount": 99,
	...
	card_pantryraider.card_draw_actions.append(		{
			Scripts.ACTION_PICK_CARDS: {
				...
				"card_pick_type": HandManager.DRAW_PILE,
				"card_pick_text": "Choose {0} card(s) to add to hand. {1} cards selected",
				"validator_data": [{Scripts.VALIDATOR_CARD_ID:{"card_object_ids":["card_fish","card_root","card_delicacy"]}}],
				"action_data": [
				{
					Scripts.ACTION_ADD_CARDS_TO_HAND:{
	...
	card_staticrecaster.card_name = "Static Recaster"
	...
	card_hoardingstowaway.card_description = "Weave [number_of_cards] Scroll, then return all Craft cards to your hand."
	card_hoardingstowaway.card_keyword_object_ids = ["keyword_weave","keyword_scroll"]
	card_hoardingstowaway.card_type = CardData.CARD_TYPES.FACTION
	card_hoardingstowaway.card_subtype = CardData.CARD_SUBTYPES.JADE
	...
	card_supremerecaster.card_description = "Weave a Scroll, Cook a Delicacy, then Sift [draw_count] for Crafts."
	card_supremerecaster.card_keyword_object_ids = ["keyword_weave","keyword_scroll", "keyword_cook", "keyword_delicacy"]
	card_supremerecaster.card_type = CardData.CARD_TYPES.FACTION
	...
	card_culinarydruid.card_type = CardData.CARD_TYPES.FACTION
	...
	card_culinarydruid.card_play_actions = [
		...
		Scripts.ACTION_PICK_CARDS:
		{
			...
			"card_pick_type": HandManager.HAND_PILE,
			"card_pick_text": "Choose {0} card to add. {1} cards selected",
			"validator_data": [{Scripts.VALIDATOR_CARD_ID: {"card_object_ids": ["card_delicacy"]}}],
			"action_data": [{
				Scripts.ACTION_DECORATE_CARDS:{"decorate_parent_card": false,"card_decorator_object_id":"card_decorator_extra_draw"}
		}]
		}
		}]
	...
	card_villagehero.card_type = CardData.CARD_TYPES.FACTION
	card_villagehero.card_subtype = CardData.CARD_SUBTYPES.JADE
	...
	card_villagehero.card_influence = 4
	...
	card_solverofriddles.card_description = "Exhaust 1 Scroll or Missive in hand to gain 2{0}, 2{1}, 2{2}, 2{3}".format([Card.FOOD_ICON_KEYWORD,Card.ORE_ICON_KEYWORD,Card.MONEY_ICON_KEYWORD,Card.INSIGHT_ICON_KEYWORD])
	card_solverofriddles.card_type = CardData.CARD_TYPES.FACTION
	card_solverofriddles.card_subtype = CardData.CARD_SUBTYPES.JADE
	...
	card_solverofriddles.card_play_actions = [
		...
		Scripts.ACTION_PICK_CARDS:
		{
			...
			"validator_data": [{Scripts.VALIDATOR_CARD_ID:{"card_object_ids":["card_scroll","card_missives"]}}],
...
func add_cards_gold() -> void:
	...
	card_spiceguard.card_description = "Forge [number_of_cards] Swords.".format([Card.EXPLORE_ICON_KEYWORD])
	card_spiceguard.card_keyword_object_ids = ["keyword_forge","keyword_sword"]
	...
	card_courtinspector.card_type = CardData.CARD_TYPES.FACTION
	card_courtinspector.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	card_courtinspector.card_rarity = CardData.CARD_RARITIES.COMMON
	card_courtinspector.card_requires_target = false
	card_courtinspector.card_energy_cost = 2
	...
	card_courtmarshall.card_description = "Explore [damage]{0}.\nFRONTIER: Explore [custom_damage]{0} instead.".format([Card.EXPLORE_ICON_KEYWORD])
	card_courtmarshall.card_keyword_object_ids = ["keyword_frontier"]
	card_courtmarshall.card_type = CardData.CARD_TYPES.FACTION
	...
	card_cengkihemissary.card_values = {"min_card_amount":2, "max_card_amount":2}
	...
	card_happysailor.card_description = "Explore [damage]{0}. Sift [draw_count] for Resource cards.".format([Card.EXPLORE_ICON_KEYWORD])
	card_happysailor.card_keyword_object_ids = ["keyword_sift"]
	card_happysailor.card_type = CardData.CARD_TYPES.FACTION
	card_happysailor.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_shucker.card_values = {"money_amount":2,"created_card_object_id":"card_fish","number_of_cards":1}
	...
	card_esteemedmerchant.card_description = "Draft Trade Orders twice. Add the first Trade order to your hand."
	#card_esteemedmerchant.card_keyword_object_ids = ["keyword_forge","keyword_treasure"]
	card_esteemedmerchant.card_type = CardData.CARD_TYPES.FACTION
	card_esteemedmerchant.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	card_esteemedmerchant.card_rarity = CardData.CARD_RARITIES.UNCOMMON
	...
	card_logisticssupervisor.card_type = CardData.CARD_TYPES.FACTION
	card_logisticssupervisor.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	card_logisticssupervisor.card_rarity = CardData.CARD_RARITIES.UNCOMMON
	card_logisticssupervisor.card_requires_target = false
	card_logisticssupervisor.card_energy_cost = 3
	card_logisticssupervisor.card_influence = 5
	card_logisticssupervisor.card_values = {"ore_required": 2, "number_of_cards":2, "created_card_object_id":"card_sword"}
	card_logisticssupervisor.card_upgrade_value_improvements = {"ore_required": 1, "number_of_cards":1}
	card_logisticssupervisor.card_play_actions.append({
		Scripts.ACTION_PICK_CARDS:
		{
			"min_card_amount":99,
			"max_card_amount":99,
	...
	card_flintlockcrier.card_type = CardData.CARD_TYPES.FACTION
	card_flintlockcrier.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_cunningeyedguard.card_type = CardData.CARD_TYPES.FACTION
	card_cunningeyedguard.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_cengkihrecruiter.card_type = CardData.CARD_TYPES.FACTION
	card_cengkihrecruiter.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_royalcook.card_description = "If you have 20 or more cards in draw pile, gain [insight_amount]{0}, then Cook [number_of_cards] Delicacy/ies.".format([Card.INSIGHT_ICON_KEYWORD])
	...
	card_cengkihnoble.card_type = CardData.CARD_TYPES.FACTION
	card_cengkihnoble.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_cengkihascetic.card_glow_validators = [{Scripts.VALIDATOR_CARD_POSITION_IN_HAND:{"position_in_hand":"right"}}]
	card_cengkihascetic.card_play_actions = [
			{
				Scripts.ACTION_VALIDATOR:
					{
						"validator_data":[{Scripts.VALIDATOR_CARD_POSITION_IN_HAND:{"position_in_hand":"right"}}],
	...
	card_tradingenvoy.card_description = "Discard up to 2 cards in hand to gain [money_amount]{0} each.".format([Card.MONEY_ICON_KEYWORD])
	card_tradingenvoy.card_type = CardData.CARD_TYPES.FACTION
	card_tradingenvoy.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
	...
	card_tradingenvoy.card_values = {"max_card_amount": 2, "money_amount": 3}
	card_tradingenvoy.card_upgrade_value_improvements = {"money_amount": 1}
	...
	card_provisionalcaptain.card_description = "Rattle all Faction cards in discard pile. Wield all Swords in discard pile."
	card_provisionalcaptain.card_keyword_object_ids = ["keyword_rattle","keyword_wield"]
	card_provisionalcaptain.card_type = CardData.CARD_TYPES.FACTION
	card_provisionalcaptain.card_subtype = CardData.CARD_SUBTYPES.CENGKIH
