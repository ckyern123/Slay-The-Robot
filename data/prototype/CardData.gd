...
# Card Type
enum CARD_TYPES {ATTACK, SKILL, POWER, STATUS, FACTION, CURSE, CRAFT, RESOURCE, ORDER}
enum CARD_SUBTYPES {NEUTRAL, FOOD, FORGED, WOVEN, BOOK, PEARL, JADE, ANISEED, CENGKIH}
const STANDARD_CARD_TYPES: Array[int] = [CARD_TYPES.ATTACK, CARD_TYPES.SKILL, CARD_TYPES.POWER, CARD_TYPES.FACTION]
...
@export var card_end_of_turn_discard_pile_actions: Array[Dictionary] = [] # actions that trigger when the card is in discard pile end of turn
